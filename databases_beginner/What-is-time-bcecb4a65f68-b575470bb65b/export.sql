...
INSERT INTO `planeten` (`Naam`, `Diameter`, `Afstand`, `Massa`, `Datum`) VALUES
('Zon', 139200, 0, 332946, NULL),
('Mercurius', 4880, 57910000, 0, NULL),
('Venus', 12104, 108208930, 1, NULL),
('Aarde', 12756, 149597870, 1, NULL),
('Mars', 6794, 227936640, 0, NULL),
('Maan', 3476000, 384000, 1, '20 juli 1969');
COMMIT;
