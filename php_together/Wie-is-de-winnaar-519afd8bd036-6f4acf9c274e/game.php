...
<body>
    <main>
        ...
        <?php
        if (!isset($_GET['speler1keuze']) && !isset($speler1keuze)) {
            // Speler 1 keuze
        ...
        } elseif (!isset($_GET['speler2keuze']) && isset($_GET['speler1keuze'])) {
        ...
        <input type="submit" value="Keuze opslaan">
            ...
            if ($speler1keuze == $speler2keuze) {
                echo "Gelijkspel!";
            } elseif (($speler1keuze == "steen" && $speler2keuze == "schaar") or ($speler1keuze == "papier" && $speler2keuze == "steen") or ($speler1keuze == "schaar" && $speler2keuze == "papier")) {
                echo "Speler 1 wint!";
            } else {
                echo "Speler 2 wint!";
            }
